...
input("Enter your name: ") #This doesn't accomplish anything on its own, as we don't save the string!
...
print("Hello", name+"!") #This is a use case for the input, incorporating it into a response!
...
print("The type of a is", type(a)) #this will show that a is a string even if the user entered a number
...
d = bool(input("Enter an boolean (first letter capital!): "))
